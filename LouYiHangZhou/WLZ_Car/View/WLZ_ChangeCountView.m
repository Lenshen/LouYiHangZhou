...
- (void)setUpViews
{
    ...
    _subButton.frame = CGRectMake(0, 0, [UIImage imageNamed:@"减"].size.width, [UIImage imageNamed:@"减"].size.height);
    
    
    [_subButton setBackgroundImage:[UIImage imageNamed:@"减"] forState:UIControlStateNormal];
    [_subButton setBackgroundImage:[UIImage imageNamed:@"减"] forState:UIControlStateDisabled];
    ...
    _numberFD = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_subButton.frame), 0, 40, _subButton.frame.size.height)];
...
//    _numberFD.layer.borderWidth = 0.5;
    ...
    _addButton.frame = CGRectMake(CGRectGetMaxX(_numberFD.frame), 0, [UIImage imageNamed:@"加"].size.width, [UIImage imageNamed:@"加"].size.height);
    _addButton.backgroundColor=[UIColor clearColor];
    
    [_addButton setBackgroundImage:[UIImage imageNamed:@"加"] forState:UIControlStateNormal];
    [_addButton setBackgroundImage:[UIImage imageNamed:@"加"] forState:UIControlStateDisabled];
